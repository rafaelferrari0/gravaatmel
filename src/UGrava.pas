...
Atualmente o site não existe mais, mas pode ser visto como era em 2008 neste link:
...
STR_COPYRIGHT = '"GRAVA ATMEL" (porta serial) v3.3, ©2021 Rafael B. Ferrari.' +#13 + #10 + 'rafaelbf@hotmail.com';
...
STR_COPYRIGHT = '"GRAVA ATMEL" (Atmel Write) (serial port) v3.3, ©2021 Rafael B. Ferrari.' +#13 + #10 + 'rafaelbf@hotmail.com';
